...
const ThemeToggle = () => {
    ...
    <button aria-controls="theme-toggle" className="theme-toggle w-12 h-12 relative hover:bg-hover-light rounded-md">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-7 aspect-square">
