...
const ThemeToggle = () => {
    return <form className="justify-self-end" id="theme-toggle" action="theme-toggle">
    <button aria-controls="theme-toggle" className="theme-toggle w-14 h-14 relative hover:bg-surface-1-accent rounded-md">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-10 aspect-square">
            ...
            <path className="theme-toggle__status theme-toggle__sun" d="M12 18a6 6 0 1 1 0-12a6 6 0 0 1 0 12zm0-2a4 4 0 1 0 0-8a4 4 0 0 0 0 8zM11 1h2v3h-2V1zm0 19h2v3h-2v-3zM3.515 4.929l1.414-1.414L7.05 5.636L5.636 7.05L3.515 4.93zM16.95 18.364l1.414-1.414l2.121 2.121l-1.414 1.414l-2.121-2.121zm2.121-14.85l1.414 1.415l-2.121 2.121l-1.414-1.414l2.121-2.121zM5.636 16.95l1.414 1.414l-2.121 2.121l-1.414-1.414l2.121-2.121zM23 11v2h-3v-2h3zM4 11v2H1v-2h3z"/>
                {/**  Moon */}
            <path className="theme-toggle__status theme-toggle__moon" fill="var(--surface-1-accent)" d="M12 2a9.91 9.91 0 0 0-3 .46a10 10 0 0 1 0 19.08A10 10 0 1 0 12 2Z"/>
            </g>
        </svg>  
        </span>
