            ...
            <div className="w-full mt-8">
                <div className="hero-container text-left">
                    ...
                    <h1 className="uppercase leading-none heading-1">
                        <span className="text-fluid-6 leading-none pl-4  text-accent-text-2 md:text-fluid-9 md:pl-6 font-black la:text-fluid-8 la:pl-7">
                            Adebola
                        </span>
                        <span className="heading-4 text-fluid-3 leading-none font-black pl-2 text-accent-text-2 block mt-[-.4rem] md:text-fluid-7 la:mt-[-1rem]">
                            Adesina
                        </span>
                    </h1>
                </div>
