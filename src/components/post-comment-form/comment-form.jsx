...
function PostCommentForm() {
    return (<div id="comments--form-wrapper" className="grid bg-surface-4 w-full gap-2 p-2">
        ...
        <form action="" id="comments--form" className="p-2">
            ...
            <button className="comments--form__ctl px-4 py-2 bg-brand text-fluid-0 font-bold text-accent-text-1 rounded-full w-full uppercase hover:bg-accent-surface-1 border-2 border-solid border-[goldenrod]" type="s ubmit">Post Comment</button>
        </form>
