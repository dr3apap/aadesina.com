...
const Nav = ({ items, post }) => {
    ...
    return <nav className={`grid grid-flow-row-dense ${post ? 'grid-cols-2' : 'grid-cols-3'} sm:grid-rows-[1fr] px-2 bg-surface-alpha z-10 sticky top-0 left-0`}>
