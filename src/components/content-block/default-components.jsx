...
const defaultComponents = {
    ...
    li({ node, className, children, index, ...props }) {
        let key
        ...
        if (className == 'links') return (<li style={{ "--i": 3 }} className="offer mb-2 la:mb-0"><span className="flex gap-x-1">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
                fill="currentColor"
        ...
        return (
            <div className="m-0 mb-6 max-w-[100vw]">
                <iframe
                    ...
                    title={props.title || 'A demo from dr3'}
                    src={props.src}
                    loading="lazy"
                ...
                >
                    ...
                    <a href="https://aadesina.com/">dr3</a>.
                </iframe>
            </div>
        )
    },
        ...
        return (
            <div className="m-0 mb-6 max-w-[100vw] col-span-full">
                <iframe
                    className="w-full aspect-[3/2]"
                    title={props.title || 'A demo from dr3'}
                    src={`https://codepen.dr3apap/embed/preview/${props.id}?default-tab=result&editable=true&theme-id=72930`}
                    loading="lazy"
                    allowtransparency="true"
                    allowFullScreen={true}
                >
                    Check out the{' '}
                    <a href={`https://codepen.dr3apap/${props.id}`}>demo pen</a> by dr3 (
                    <a href="https://codepen.dr3apap">@dr3</a>) over on{' '}
                    <a href={`https://codepen.dr3apap/${props.id}`}>CodePen</a>.
                </iframe>
            </div>
        )
    },
